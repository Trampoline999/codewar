...
-- CreateIndex
CREATE INDEX "TestCasesResult_submmissionId_idx" ON "TestCasesResult"("submmissionId");
...
-- AddForeignKey
ALTER TABLE "TestCasesResult" ADD CONSTRAINT "TestCasesResult_submmissionId_fkey" FOREIGN KEY ("submmissionId") REFERENCES "Submission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
